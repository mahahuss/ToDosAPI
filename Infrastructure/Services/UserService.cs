...
public class UserService
{
    ...
    public async Task<Result<UserWithRolesDto?>> AddNewUserAsync(RegisterDto registerDto)
    {
        ...
        return createdUser != null
            ? await _userRepo.GetUserWithRolesAsync(registerDto.Username)
            : Result<UserWithRolesDto?>.Failure("Failed to register");
    }
    ...
    public async Task<Result<string>> EditProfileAsync(UpdateUserProfileDto updateUserInfo, int id)
    {
        ...
        return result
            ? Result<string>.Successful("Profile updated successfully")
            : Result<string>.Failure("Failed to update profile");
    }
    ...
    public async Task<Result<string>> ChangeUserStatusAsync(int userId, bool status)
    {
        ...
        return result
            ? Result<string>.Successful("User status changed successfully")
            : Result<string>.Failure("Failed to change user status");
    }
